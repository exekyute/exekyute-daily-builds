...
function parsePositionCsv(text) {
    ...
    for (let i = 1; i < lines.length; i++) {
        ...
        rows.push({ date, account, direction: direction, amountCents, description });
    }
    if (rows.length === 0) {
...
function summarize(positions, movements) {
 ...
 */
function toClosingBalancesCsv(positions) {
