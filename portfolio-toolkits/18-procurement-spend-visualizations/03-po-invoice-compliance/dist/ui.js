 ...
 */
function drawBreakdown(summary) {
    const svg = el("breakdown");
...
function drawFlaggedTable(lines) {
    const tbody = el("flaggedBody");
    tbody.innerHTML = "";
...
function render(text) {
    ...
    setMessage(`Checked ${summary.totalLines} lines. ${summary.compliantLines} compliant, ${summary.offContractLines} off-contract, ${summary.exceptionLines} match exceptions.`, "info");
}
