...
<tr><td><a href="hrm-open-data/15-arena-booking-utilization">15 Arena Booking Utilization</a></td><td>Measures how fully Halifax's 12 municipal arena pads are booked across 39,855 bookings and 107,533.25 booked hours, with ice 70.11 percent of the total and Arena the busiest pad at 19,995.25 hours: a facility-by-month booked-hours heatmap over an ice-versus-dry-floor stacked area in <strong>Tableau</strong>, a booked-hours matrix with a same-period-last-year line and a RANKX facility ranking in <strong>Power BI</strong>.</td><td>07/30/2026</td></tr>
<tr><td><a href="hrm-open-data/14-municipal-building-energy">14 Municipal Building Energy and Emissions</a></td><td>Ranks Halifax's $86,444,113.77 of municipal building energy cost across 160 buildings and four fuels, with electricity the largest at $64,450,969.11 and Scotiabank Centre the costliest building at $6,127,063.69: a cost-by-building stacked bar over faceted per-fuel consumption panels in <strong>Tableau</strong>, a cost decomposition tree with a cost-per-unit matrix and a RANKX building ranking in <strong>Power BI</strong>.</td><td rowspan="3">07/24/2026</td></tr>
<tr><td><a href="hrm-open-data/13-snow-service-coverage">13 Snow Service Coverage</a></td><td>Carves up Halifax's winter maintenance geography across 32 street service areas, 23 sidewalk zones, and 18,736 ice-route segments, with Priority 1 routes totalling 1,724.03 km and the street network split four ways (HRM 14 areas, federal 11, province 6, airport 1): a filled service-area map with the ice-route network coloured by priority in <strong>Tableau</strong>.</td></tr>
<tr><td><a href="hrm-open-data/12-speed-management-inventory">12 Speed Management Inventory</a></td><td>Maps Halifax's 73 speed display signs, 707 traffic control locations, and 13,835 neighbourhood road segments carrying 6,905.74 km of posted speed limits, of which only 410.41 km (5.9 percent) sits below the 50 km/h default: a device map coloured by type layered over the reduced-speed street network in <strong>Tableau</strong>.</td></tr>
...
Small DuckDB SQL analyses built on real datasets from the Nova Scotia Open Data portal, plus five formula-driven Excel models. Each build keeps a checked-in snapshot of its source data and a golden copy of the expected output, so the numbers reproduce exactly every time the build runs.

<table>
<tr><th>Project</th><th>What it does</th><th>Last Updated</th></tr>
<tr><td><a href="ns-open-data-sql/21-water-quality-compliance">21 Water Quality Compliance</a></td><td>Scores 2,496 surface water results from eight river monitoring stations against ten fixed CCME aquatic-life guidelines, 2002 to 2024, converting every reading into the unit its guideline is written in before any comparison, and accounting for all 38,143 published rows in a ledger that names each exclusion rather than dropping it, with 96.19 percent of results passing, iron the only analyte breaching regularly at 76.04 percent and just 29.49 percent at Kelley River at Eight Mile Ford, 18,274 rows collapsed as byte-identical duplicates of another row, and 621 passes flagged unconfirmable because they are non-detects reported at a limit above their own guideline, plus a Power BI compliance report.</td><td>07/27/2026</td></tr>
<tr><td><a href="ns-open-data-sql/20-agriculture-funding-audit">20 Agriculture Funding Audit</a></td><td>Audits 6,324 agriculture funding payments worth $75,357,902.03 across eleven fiscal years, ranking recipients by total dollars with a running concentration curve, sharing out all 106 programs, tracking each division year over year, and flagging duplicate-payment candidates by an explicit rule, with Millen Farms Ltd the largest recipient at $983,581.28, the top 10 recipients holding only 9.07 percent of all dollars, and 9 candidate groups worth $308,000.00 beyond their first occurrences, plus a Power BI Pareto report.</td><td>07/26/2026</td></tr>
<tr><td><a href="ns-open-data-sql/19-coop-registry-longevity">19 Co-op Registry Longevity</a></td><td>Profiles all 369 co-operatives on the province's registry by incorporation cohort, measuring each decade's surviving count, its share of today's registry, and its non-profit mix against a pinned pull date, with 65.3 percent of the registry non-profit overall, the 1930s cohort still holding 10 co-ops (the oldest incorporated in March 1936, 90.3 years on), and the mix flipping from no non-profits at all before 1960 to 82.3 percent in the 1980s, plus a Power BI cohort report.</td><td>07/25/2026</td></tr>
<tr><td><a href="ns-open-data-sql/18-climate-projection-summary">18 Climate-Projection Summary</a></td><td>Summarizes the province's CMIP5 climate projections as per-county temperature deltas against the 1981-2010 baseline in a formula-driven Excel workbook, comparing the RCP4.5 and RCP8.5 scenarios at the 2045 and 2095 horizons, with Cumberland showing the largest late-century change at 4.81 degrees above its baseline under RCP8.5 against an 18-county average of 4.55, and a 1.92 degree gap between the two scenarios.</td><td>07/23/2026</td></tr>
