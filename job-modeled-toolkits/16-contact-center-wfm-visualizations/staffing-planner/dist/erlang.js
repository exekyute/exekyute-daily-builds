...
function trafficIntensity(callsOffered, ahtSeconds, intervalSeconds) {
 ...
 */
function erlangB(agents, trafficA) {
    let b = 1;
 ...
 */
function erlangC(agents, trafficA) {
    if (agents <= trafficA) {
        return 1;
    }
 ...
 */
function serviceLevel(agents, trafficA, ahtSeconds, targetSeconds) {
    if (agents <= trafficA) {
        return 0;
    }
...
function requiredAgents(trafficA, ahtSeconds, targetSeconds, targetSlFraction) {
...
function planAll(forecasts, config) {
